    ...
    <div class="box box-default">
        ...
        <div class="box-body">
                ...
                <form action="<?= $action ?>" id="fpagina" name="fpagina" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type='text' class="form-control" name="titulo" id="titulo" placeholder="Digite titulo" value="<?php if(isset($pagina["titulo"]) && $pagina["titulo"] != NULL && $pagina["titulo"] != ""){echo utf8_encode($pagina["titulo"]);}?>">
                        </div>
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <button class="btn btn-primary" onclick="salvarPagina()">Cadastrar</button>
                        <button class="btn btn-primary" id="btexcluirPagamento" onclick="excluirPagina()">Excluir</button>  
                    </div>                                        
                </div>
            </div>
        </div>
