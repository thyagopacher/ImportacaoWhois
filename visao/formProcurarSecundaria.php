<div class="row">
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <form action="../control/ProcurarSecundariaRelatorio.php" method="post" name="fpsecundaria" id="fpsecundaria" onsubmit="return false;" target="_blank">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        if ($nivelp["procurar"] == 1) {
                            echo '<a onclick="procurarSecundaria(false);" class="btn btn-primary"/> ';
                            echo '<i class="fa fa-search" aria-hidden="true"></i> ';
                            echo 'Procurar';
                            echo '</a> ';
                        }
                        if ($nivelp["gerapdf"] == 1) {
                            echo '<a onclick="abreRelatorioSecundaria(1);" class="btn btn-primary"/>';
                            echo '<i class="fa fa-file-pdf-o" aria-hidden="true"></i> ';
                            echo 'Gerar PDF';
                            echo '</a> ';
                        }
                        if ($nivelp["geraexcel"] == 1) {
                            echo '<a onclick="abreRelatorioSecundaria(2);" class="btn btn-primary"/> ';
            ...
            <div class="row">
                <div class="col-sm-12" id="listagemSecundaria"></div>
            </div>
        </div>
    </div>
    <!--/.col (right) -->
